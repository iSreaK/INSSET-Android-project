...
public class SupabaseSessionStore {
    ...
    public void saveSession(String accessToken, String userId, String userEmail, String refreshToken) {
    ...
    public void saveSession(String accessToken, String userId, String userEmail) {
        saveSession(accessToken, userId, userEmail, this.refreshToken);
    }
