...
public class AppContainer {
    ...
    public AppContainer(Context context) {
        ...
        authRepository = new SupabaseAuthRepository(supabaseClientProvider);
        benchRepository = new SupabaseBenchRepository(supabaseClientProvider);
        reviewRepository = new SupabaseReviewRepository(supabaseClientProvider);
