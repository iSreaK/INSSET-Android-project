...
public class LoginViewModel extends ViewModel {
    ...
    public void restoreSession(Runnable onSuccess) {
        ...
        authRepository.loadCurrentUser(new com.insset.jvbench.core.common.ResultCallback<com.insset.jvbench.domain.model.User>() {
            @Override
    ...
    public void login(String email, String password, Runnable onSuccess) {
        uiState.postValue(new UiState(Status.LOADING, null));
        authRepository.signIn(email, password, new com.insset.jvbench.core.common.AuthCallback() {
            @Override
            public void onSuccess(com.insset.jvbench.domain.model.User result) {
