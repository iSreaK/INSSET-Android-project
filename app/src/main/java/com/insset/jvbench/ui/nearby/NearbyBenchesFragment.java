package com.insset.jvbench.ui.nearby;
...
import com.insset.jvbench.core.navigation.BenchNavigationLauncher;
...
public class NearbyBenchesFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new NearbyBenchesAdapter(new NearbyBenchesAdapter.Callbacks() {
            @Override
            public void onOpenDetail(@NonNull com.insset.jvbench.domain.model.Bench bench) {
            ...
            @Override
            public void onNavigate(@NonNull com.insset.jvbench.domain.model.Bench bench) {
